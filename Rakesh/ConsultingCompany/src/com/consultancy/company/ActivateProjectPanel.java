...
public class ActivateProjectPanel extends JPanel{

	public ActivateProjectPanel(){
		init();
	}
	...
	public void init(){
		...
		JLabel hint = new JLabel("Activate project");
		...
		submitbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				if (projectidtf.getText().trim().equals("")
	            	...
	            	JOptionPane.showMessageDialog(ActivateProjectPanel.this, "Please enter project id");

				}
				
				else if (!Util.isInteger(projectidtf.getText().trim())) {

					JOptionPane.showMessageDialog(ActivateProjectPanel.this,
	            	...
	            	JOptionPane.showMessageDialog(ActivateProjectPanel.this, "Project Activated");
